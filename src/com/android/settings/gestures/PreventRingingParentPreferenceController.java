...
public class PreventRingingParentPreferenceController extends TogglePreferenceController
    ...
    public boolean isChecked() {
        ...
        if (preventRinging == null) preventRinging = FLAMINGO_VOLUME_HUSH_OFF;
        return !preventRinging.equals(FLAMINGO_VOLUME_HUSH_OFF);
    }
    ...
    public boolean setChecked(boolean isChecked) {
        String preventRingingSetting = Settings.Secure.getString(
                mContext.getContentResolver(), VOLUME_HUSH_GESTURE);
        if (preventRingingSetting == null) preventRingingSetting = FLAMINGO_VOLUME_HUSH_OFF;

        final String newRingingSetting = preventRingingSetting.equals(FLAMINGO_VOLUME_HUSH_OFF)
                ? FLAMINGO_VOLUME_HUSH_VIBRATE : preventRingingSetting;

        return Settings.Secure.putString(mContext.getContentResolver(),
                VOLUME_HUSH_GESTURE, isChecked
                        ? newRingingSetting
                        : FLAMINGO_VOLUME_HUSH_OFF);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (value == null) value = FLAMINGO_VOLUME_HUSH_OFF;
        String summary = null;
        if (isVolumePowerKeyChordSetToHush()) {
            if (value.equals(FLAMINGO_VOLUME_HUSH_OFF)) {
